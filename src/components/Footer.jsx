...
function Footer() {
  return (
    <div style={{height:'300px'}} className='d-flex justify-content-center align-items-center w-100 flex-column bg-primary text-white'>
        <div className='d-flex justify-content-evenly align-items-center w-100'> 
            <div className='websites' style={{width:'400px'}}>
            <h4 className='mb-3' style={{color:'white'}}>
            <i class="fa-solid fa-cart-shopping fa-beat me-3 fs-5 fs-light"></i>
            E-Cart
            </h4>
            <h6 style={{textAlign:'justify',color:'white'}}>Lorem ipsum dolor sit amet consectetur adipisicing elit. 
                ...
                <h6 style={{textAlign:'justify',color:'white'}}> Lorem ipsum, dolor sit amet consectetur  </h6>
            ...
            <div className='links d-flex flex-column'>
                ...
                <Link to={'/whishlist'} style={{textDecoration:'none',color:'white'}}>Wish List</Link>
